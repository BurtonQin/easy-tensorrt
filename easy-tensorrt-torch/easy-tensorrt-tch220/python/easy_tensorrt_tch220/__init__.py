...
if not torch.cuda.is_available():
    raise RuntimeError("easy-tensorrt-tch220 requires a CUDA-enabled PyTorch installation.")
...
from .easy_tensorrt_tch220 import *

# Forward module-level docstring and __all__ if present
import easy_tensorrt_tch220 as _mod
