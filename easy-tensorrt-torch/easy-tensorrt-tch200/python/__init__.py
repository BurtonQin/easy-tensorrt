...
if not torch.cuda.is_available():
    raise RuntimeError("easy-tensorrt-tch200 requires a CUDA-enabled PyTorch installation.")
...
from .easy_tensorrt_tch200 import *

# Forward module-level docstring and __all__ if present
import easy_tensorrt_tch200 as _mod
