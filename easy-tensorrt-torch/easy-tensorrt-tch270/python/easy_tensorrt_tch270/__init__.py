...
if not torch.cuda.is_available():
    raise RuntimeError("easy-tensorrt-tch270 requires a CUDA-enabled PyTorch installation.")
...
from .easy_tensorrt_tch270 import *

# Forward module-level docstring and __all__ if present
import easy_tensorrt_tch270 as _mod
