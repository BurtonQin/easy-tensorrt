...
if not torch.cuda.is_available():
    raise RuntimeError("easy-tensorrt-tch250 requires a CUDA-enabled PyTorch installation.")
...
from .easy_tensorrt_tch250 import *

# Forward module-level docstring and __all__ if present
import easy_tensorrt_tch250 as _mod
