...
if not torch.cuda.is_available():
    raise RuntimeError("easy-tensorrt-tch260 requires a CUDA-enabled PyTorch installation.")
...
from .easy_tensorrt_tch260 import *

# Forward module-level docstring and __all__ if present
import easy_tensorrt_tch260 as _mod
