...
pub(crate) mod ffi {
    ...
    unsafe extern "C++" {
        include!("easy-tensorrt-sys/cxx/include/logger.h");
    ...
    unsafe extern "C++" {
        include!("easy-tensorrt-sys/cxx/include/runtime.h");
    ...
    unsafe extern "C++" {
        include!("easy-tensorrt-sys/cxx/include/plugin.h");

        fn init_libnv_infer_plugins() -> bool;
